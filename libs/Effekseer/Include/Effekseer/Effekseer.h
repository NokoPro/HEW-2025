...
private:
    ...
    // File I/O interface used by loaders
    FileInterfaceRef fileInterface_ = nullptr;
...
public:
	...
	*/
    ...
    /**
        @brief
        \~English get a file interface
        \~Japanese ファイルインターフェースを取得する。
    */
    FileInterfaceRef GetFileInterface() const
    {
    ...
    /**
        @brief
        \~English specify a file interface
        \~Japanese ファイルインターフェースを設定する。
    */
    void SetFileInterface(FileInterfaceRef fileInterface)
    {
