...
#pragma once
/*****************************************************************//**
 * @file   ResultUiRenderSystem.h
 * @brief  ResultUiRenderComponent を持つエンティティを描画するSystem
 *
 * - ResultUiRenderComponent を持っているエンティティをすべて描画する
...
#include <algorithm>
 ...
 /**
   ...
   */
class ResultUiRenderSystem : public IRenderSystem
{
private:
    /**
