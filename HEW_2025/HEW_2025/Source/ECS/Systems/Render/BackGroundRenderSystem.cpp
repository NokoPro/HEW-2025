/*****************************************************************//**
 * @file   BackGroundRenderSystem.cpp
 * @brief  BackGroundComponent を持つエンティティを描画するSystem
 *
 * @author 土本蒼翔
 * @date   2025/11/25
 *********************************************************************/
...
void BackGroundRenderSystem::Render(const World& world)
{
	...
	world.View<TransformComponent, BackGroundComponent>(
		[&](EntityId, const TransformComponent& tr, const BackGroundComponent& sp)
		{
